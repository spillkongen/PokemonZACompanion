...
# In Z-A, women's-style cuts use names like Blouse & Skort; men's cuts use Shirt, Cargo Pants, etc.
...
FEMININE_MARKERS = (
    ...
    "overalls set",  # many women's overalls on Serebii
...
def main():
    ...
    payload = {
        ...
        "note": "All outfits work on any character. Women's/Men's filters match Serebii outfit names (blouse/skort vs shirt/cargo).",
    ...
    print("wrote", len(items), "items,", fem, "women's-style,", masc, "men's-style")
